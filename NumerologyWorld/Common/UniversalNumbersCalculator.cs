...
namespace Numerology.Common
{
    ...
    public class UniversalNumbersCalculator
    {
        #region Declarations

        int UniversalYearNum;
        ...
        #region Constructor
        public UniversalNumbersCalculator(DateTime? _birthDate, bool _calcLifePathSeparately)
        {
        ...
        public string GetUniversalYearNumber()
        {
            ...
            if (BirthDate != null && BirthDate.Value != null)
            {
                ...
                UniversalYearNum = yearIntNatural;
        
                return GetNaturalNumberString(UniversalYearNum);
            }
            else
            {
                return "";
        ...
        {
            int monthNum = GetUniversalYearNumberNatural() + monthNumber;
        ...
        private int GetUniversalYearNumberNatural()
        {
            int universalYearNumNatural;
            if (UniversalYearNum.ToString().Length > 3)
            {
                universalYearNumNatural = Convert.ToInt16(UniversalYearNum.ToString().Substring(3, 1));
            }
            else
            {
                universalYearNumNatural = Convert.ToInt16(UniversalYearNum);
            }
            return universalYearNumNatural;
        }
